...
public class Traffic_Fine
{
    public static int calculateChallan(int n,int[]arr,int D,int C)
    {
        int fine=0;
        for(int i=0;i<n;i++){
            if(D%2==0){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(calculateChallan(n,arr,D,C));
    }
}
/*
Particulate matters are the biggest contributors to Delhi pollution. The main reason behind the increase in
the concentration of PMs include vehicle emission by applying Odd Even concept for all types of vehicles.
...
Hence, the output = 600.Example 2:
Input:
5 -> Value of N
...
First input - Accept for N(Positive integer) values (a[]), where each value is separated by a new lin
